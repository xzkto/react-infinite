            ...
            var scaleEnum = require('./utils/scaleEnum'),
              ...
              Infinite = (function(e) {
                function t(e) {
                  ...
                  var n = o.newState;
                  return (n.scrollTimeout = void 0), (n.isScrolling = !1), (i.state = n), (i.horizontal =
                    e.axis === 'x'), i;
                }
                ...
                return (i.getLoadingSpinnerHeight = function() {
                  ...
                  : (
                      ...
                      (i.getScrollTop = function() {
                        return e.scrollable
                          ? e.horizontal
                            ? e.scrollable.scrollLeft
                            : e.scrollable.scrollTop
                          : 0;
                      }),
                      (i.setScrollTop = function(t) {
                        e.scrollable &&
                          (e.horizontal
                            ? (e.scrollable.scrollLeft = t)
                            : (e.scrollable.scrollTop = t));
                      }),
          ...
          (function(global) {
            ...
            function recomputeApertureStateFromOptionsAndScrollTop(e, t) {
              var o = e.preloadBatchSize,
                ...
                l = a + o,
                p = Math.max(0, a - n),
                u = Math.min(r.getTotalScrollableHeight(), l + n);
              return {
                displayIndexStart: r.getDisplayIndexStart(p),
            ...
            function generateComputedProps(e) {
              ...
              (t =
                typeof t === 'number'
                  ? t
                  : 0), (l.containerHeight = e.useWindowAsScrollContainer
                ? window.innerHeight
                : t), (l.handleScroll = r || function() {}), (l.onInfiniteLoad =
                i || function() {});
              var p = {
                  type: scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR,
                  amount: 0.5
                ...
                u = o && o.type ? o : p;
              typeof o === 'number'
                ? (l.preloadBatchSize = o)
                : (void 0 === u ? 'undefined' : _typeof(u)) === 'object' &&
                  u.type === scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR
                  ? (l.preloadBatchSize = l.containerHeight * u.amount)
                  : (l.preloadBatchSize = 0);
              var c = {
                  type: scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR,
                  amount: 1
                },
              ...
              return typeof n === 'number'
                ? (l.preloadAdditionalHeight = n)
                : (void 0 === d ? 'undefined' : _typeof(d)) === 'object' &&
                  d.type === scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR
                  ? (l.preloadAdditionalHeight = l.containerHeight * d.amount)
                  : (l.preloadAdditionalHeight = 0), Object.assign(a, l);
            }
            function buildHeightStyle(e, t) {
              return t
                ? { height: '100%', width: Math.ceil(e) }
                : { width: '100%', height: Math.ceil(e) };
            }
            var _typeof =
